...
@section('content')
    <div class="span9">
        ...
        <ul class="thumbnails">
            <li class="span3">
                <div class="thumbnail">
                    <a href="{{ url('/chitiet') }}"><img src="themes/images/products/6.jpg" alt="" /></a>
                    <div class="caption">
                        <h5>Product name</h5>
                        <p>
            ...
            <li class="span3">
                <div class="thumbnail">
                    <a href="{{ url('/chitiet') }}"><img src="themes/images/products/7.jpg" alt="" /></a>
                    <div class="caption">
                        <h5>Product name</h5>
                        <p>
                            Lorem Ipsum is simply dummy text.
            ...
            <li class="span3">
                <div class="thumbnail">
                    <a href="{{ url('/chitiet') }}"><img src="themes/images/products/8.jpg" alt="" /></a>
                    <div class="caption">
                        <h5>Product name</h5>
                        <p>
                            Lorem Ipsum is simply dummy text.
            ...
            <li class="span3">
                <div class="thumbnail">
                    <a href="{{ url('/chitiet') }}"><img src="themes/images/products/9.jpg" alt="" /></a>
                    <div class="caption">
                        <h5>Product name</h5>
                        <p>
                            Lorem Ipsum is simply dummy text.
            ...
            <li class="span3">
                <div class="thumbnail">
                    <a href="{{ url('/chitiet') }}"><img src="themes/images/products/10.jpg" alt="" /></a>
                    <div class="caption">
                        <h5>Product name</h5>
                        <p>
                            Lorem Ipsum is simply dummy text.
            ...
            <li class="span3">
                <div class="thumbnail">
                    <a href="{{ url('/chitiet') }}"><img src="themes/images/products/11.jpg" alt="" /></a>
                    <div class="caption">
                        <h5>Product name</h5>
                        <p>
                            Lorem Ipsum is simply dummy text.
